 ...
 * implementation class (marked with the {@code jakarta.interceptor.Interceptor @Interceptor} annotation
 * to associate that annotation with an interceptor.  The annotation may then be applied instead of, or
 * in addition to, the {@code jakarta.interceptor.Interceptors @Interceptors} annotation to specify
